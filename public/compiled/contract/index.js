...
class _Either_1 {
  ...
  toValue(value_0) {
    return _descriptor_6.toValue(value_0.is_left).concat(_descriptor_1.toValue(value_0.left).concat(_descriptor_3.toValue(value_0.right)));
  }
}
...
export class Contract {
    ...
    this.circuits = {
      mint: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_5.toValue(value_0).concat(_descriptor_3.toValue(recipient_0)),
            alignment: _descriptor_5.alignment().concat(_descriptor_3.alignment())
          },
          output: undefined,
          publicTranscript: [],
      ...
      sendToken: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`sendToken: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const amount_0 = args_1[1];
        const recipient_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('sendToken',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(amount_0).concat(_descriptor_3.toValue(recipient_0)),
      ...
      receiveToken: (...args_1) => {
        ...
        const amount_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('receiveToken',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const result_0 = this._receiveToken_0(context,
                                              partialProofData,
                                              amount_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(0n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(new Uint8Array([97, 97, 97, 97, 65, 65, 65, 65, 97, 97, 97, 97, 65, 65, 65, 65, 97, 97, 97, 97, 65, 65, 65, 65, 97, 97, 97, 97, 65, 65, 65, 65])),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _mint_0(context, partialProofData, value_0, recipient_0) {
  ...
  _sendToken_0(context, partialProofData, amount_0, recipient_0) {
    const color_0 = this._tokenType_0(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                partialProofData,
                                                                                                [
                                                                                                 { dup: { n: 0 } },
                                                                                                 { idx: { cached: false,
  ...
  _receiveToken_0(context, partialProofData, amount_0) {
    const color_0 = this._tokenType_0(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                partialProofData,
                                                                                                [
                                                                                                 { dup: { n: 0 } },
